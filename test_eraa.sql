...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2020 at 09:27 PM
...
CREATE TABLE `services` (
  ...
  `service_is_active` enum('0','1') NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`city_id`) REFERENCES `cities` (`city_id`),
